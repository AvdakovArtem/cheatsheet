...
- **«Откатить» изменения, которые не попали ни в `staging`, ни в *коммит*:** Команда 1git restore <file>1 «*откатит*» изменения в файле до последней сохранённой (в *коммите* или в `staging`) версии.  

## Просматр изменения в файлах  
